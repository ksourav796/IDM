...
public class CustomerNotifications {
  ...
  public String getRiderChangeData() {
    return riderChangeData;
  }

  public void setRiderChangeData(String riderChangeData) {
    this.riderChangeData = riderChangeData;
  }

  public String getStatusChangeData() {
    return statusChangeData;
  }

  public void setStatusChangeData(String statusChangeData) {
