...
//
//            private final static TestMailServer.SmtpServer smtpServer = TestMailServer.smtp(587);
//
//            private final static TestMailServer.Pop3Server pop3Server = TestMailServer.pop3(995);
//
//            private final static TestMailServer.ImapServer imapServer = TestMailServer.imap(993);
//
//            private final static TestMailServer.ImapServer imapIdleServer = TestMailServer.imap(993);
//
//
//            @BeforeClass
...
////        assertEquals("hinexthyva@gmail.com", mm.getRecipients(RecipientType.TO)[0].toString());
////        assertEquals("azgarhussaini@gmail.com", mm.getFrom()[0].toString());
////        assertEquals("Hhhhhhhhh", mm.getSubject());
...
////                            .subjectFunction(m -> "Bbbbbbb")
////                            .from("azgarhussaini@gmail.com")
////                            .toFunction(m -> new String[] { "hinexthyva@gmail.com" }))
////                    .handle(Mail.outboundAdapter("smtp.gmail.com")
////                                    .port(smtpServer.getPort())
////                                    .credentials("hinexthyva", "hinexthiaccountshyvaproject")
////                                    .protocol("smtp")
...
//
////        pop3://[userid]:[password]@pop.gmail.com/INBOX
//
////        @Bean
////        public IntegrationFlow pop3MailFlow() {
////            return IntegrationFlows
////                    .from(Mail.pop3InboundAdapter("smtp.gmail.com", pop3Server.getPort(), "hinexthyva", "hinexthiaccountshyvaproject")
////                                    .javaMailProperties(p -> p.put("mail.debug", "false"))
...
////            return IntegrationFlows.from(Mail.imapInboundAdapter("imaps://hinexthyva:hinexthiaccountshyvaproject@imap.gmail.com/INBOX")
...
//                    return IntegrationFlows
//                            .from(Mail.imapInboundAdapter("imaps://"
//                                            + "hinexthyva"
//                                            + ":"
//                                            + "hinexthiaccountshyvaproject"
//                                            + "@imap.gmail.com:993/INBOX")
//                                            .searchTermStrategy(this::fromAndNotSeenTerm)
//                                            .userFlag("azgarhussaini")
//                                            .javaMailProperties(p -> p.put("mail.debug", "true")),
//                                    e -> e.autoStartup(true)
//                                            .poller(p -> p.fixedDelay(60000)))
...
////            return IntegrationFlows
////                    .from(Mail.imapIdleAdapter("imaps://"
////                            + "hinexthyva"
////                            + ":"
////                            + "hinexthiaccountshyvaproject"
////                            + "@imap.gmail.com:993/INBOX")
...
//                    try {
//                        FromTerm fromTerm = new FromTerm(new InternetAddress("azgarhussaini@gmail.com"));
//                        return new AndTerm(fromTerm, new FlagTerm(new Flags(Flags.Flag.SEEN), true));
//                    }
