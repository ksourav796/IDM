package com.hyva.idm.pkt.pktBeans;
 ...
 */
@Data
public class PktPermissionBean {
    ...
    private String Size;
    private String logicalopKey;
    private String calc_key;
    ...
    public String getLogicalopKey() {
        return logicalopKey;
    }

    public void setLogicalopKey(String logicalopKey) {
        this.logicalopKey = logicalopKey;
    }

    public String getCalc_key() {
        return calc_key;
    }

    public void setCalc_key(String calc_key) {
