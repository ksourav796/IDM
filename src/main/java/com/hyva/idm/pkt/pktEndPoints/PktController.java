...
public class PktController {
    ...
    @RequestMapping(value = "/getPktFieldspermissionsMasters",
            method = RequestMethod.POST, produces = MediaType.APPLICATION_JSON_VALUE)
    public IDMResponse getPktFieldspermissionsMasters(@RequestParam("tableName1") String tableName1) {
        List<PktFieldsBean> level1 = pktService.getPktFieldspermissionsMasters(tableName1);
        return new IDMResponse(HttpStatus.OK.value(), "success", level1);
    }
