...
public class SassCustomerMapper {
    ...
    public static SassCustomer mapPojoToEntity(SassCustomerPojo sassCustomerPojo) {
        ...
        sassCustomer.setCustomerId(sassCustomerPojo.getCustomerId());
...
//        sassCustomer.setIFSCCode(sassCustomerPojo.getIFSCCode());
        ...
        sassCustomer.setCreditedTerm(sassCustomerPojo.getCreditedTerm());
        sassCustomer.setCreditedLimit(sassCustomerPojo.getCreditedLimit());
        sassCustomer.setStatus(sassCustomerPojo.getStatus());
        sassCustomer.setIfsc(sassCustomerPojo.getIfsc());
        sassCustomer.setSassPaymentMethod(sassCustomerPojo.getSassPaymentMethod());
        sassCustomer.setPaymentmethodName(sassCustomerPojo.getPaymentmethodName());
        return sassCustomer;
    }
}
